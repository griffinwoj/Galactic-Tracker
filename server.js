...
function deleteDepartmentsRolesEmployees() {
    ...
    //this will prompt the user to select what they want to delete
        ...
        //this then function will run after the user selects what they want to delete
        .then((answer) => {
            switch (answer.data) {
                case "Employee":
                    deleteEmployee();
...
// This will use the Function to view Total Utilized Budget of Department
function viewTotalUtilizedBudgetOfDepartment() {
    ...
    connection.query(query, (err, res) => {
        ...
        // prompt the user to select a department and calculate the total salary for it
        inquirer
            .prompt({
                type: "list",
                name: "departmentId",
            ...
            .then((answer) => {
                // this will calculate the total salary for the selected department
                const query =
                    `SELECT 
...
// this prevents the Node process from staying alive
process.on("exit", () => {
    connection.end();
});
